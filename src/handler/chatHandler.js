...
// Configuramos la ruta de ffmpeg usando el binario proporcionado por ffmpeg-static
ffmpeg.setFfmpegPath(ffmpegPath);

// Asegúrate de que la función routeInput esté definida o importada
// Ejemplo: const routeInput = require('../services/routeInput');
